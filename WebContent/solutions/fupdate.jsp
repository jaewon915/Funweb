...
<tr><td>제목</td><td><input type="text" name="subject" value="<%=pb.getSubject()%>"></td></tr>
<tr><td>사진</td>
<td><input type="file" name="file"><input type="hidden" name="file2" value="<%=pb.getFile()%>"><%=pb.getFile()%></td></tr>
</table>
<div id="table_search">
<input type="submit" value="사진수정" class="btn">	
<input type="reset" value="다시쓰기" class="btn">	
<input type="button" value="글목록" class="btn" 
       onclick="location.href='photo.jsp?pageNum=<%=pageNum%>'">	
</div>
</form>
<div class="clear"></div>
<div id="page_control">
