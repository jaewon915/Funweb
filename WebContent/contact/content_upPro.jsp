...
//메서드 호출 updateBoard2(b2b)
int check =b2dao.updateBoard2(b2b, num2);
...
if(check == 1){
	...
	<script type="text/javascript">
		alert("수정성공");
	<%-- location.href="content_upForm.jsp?num=<%=drb.getNum()%>&num2=<%=b2b.getNum2()%>&pageNum=<%=pageNum%>"; --%>
	location.href="content_upForm.jsp?num=<%=num%>&num2=<%=num2%>&pageNum=<%=pageNum%>";
	</script>
	<%
}	
//check==0
