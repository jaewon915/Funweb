...
이름 : <input type="text" name="name2" value="<%=id%>">
...
// List board2List =	메서드 호출 getBoard2List()(몇개)
...
<form action="content_upPro.jsp?num=<%=drb.getNum()%>&num2=<%=b2b.getNum2()%>&pageNum=<%=pageNum%>" method="post" name="fr" id="center">
